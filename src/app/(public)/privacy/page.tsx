    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <section className="mb-8">
        ...
        <p className="mb-4">
          ...
          пользователей сайта <strong>tech24view.ru</strong> (далее — «Сайт»).
        </p>
        <p>
          Используя Сайт, Пользователь соглашается с условиями настоящей
      ...
      <section className="mb-8">
        ...
        <ul className="list-disc ml-8 mb-4">
          ...
          <li>
            Данные об использовании Сайта (время посещения, просмотренные
            страницы).
          </li>
          <li>
            Данные, предоставленные Пользователем (например, через формы
            обратной связи).
          </li>
        </ul>

        <p>
          2.2. Мы не собираем и не храним платежные данные, так как на Сайте
          отсутствуют функции оплаты.
        </p>
      </section>
      ...
      <section className="mb-8">
        ...
        <p>
          3.2. Мы не передаем персональные данные третьим лицам, за исключением
      ...
      <section className="mb-8">
        ...
        <p>
          4.2. Однако ни один метод передачи данных через Интернет или метод
          электронного хранения не является абсолютно безопасным. Мы не можем
      ...
      <section className="mb-8">
        ...
        <p>
          6.2. Для реализации своих прав Пользователь может связаться с
          Администрацией через контактную информацию, указанную на Сайте.
        </p>
      </section>
      ...
      <section className="mb-8">
        ...
        <p className="mb-4">
          7.1. Мы оставляем за собой право вносить изменения в настоящую
          Политику. Новая версия Политики вступает в силу с момента ее
          публикации на Сайте.
        </p>
        <p>
          7.2. Рекомендуем Пользователям регулярно проверять Политику на наличие
          изменений.
        </p>
      </section>
    </div>
