...
export function MiniReviewsCard({
  slug,
  title,
  previewImage,
}: {
  ...
  return (
    <Link href={`/reviews/${slug}`} className="w-full hover:scale-95 transition-all duration-300">
...
export function SceletonMiniReviewsCard() {
  return (
