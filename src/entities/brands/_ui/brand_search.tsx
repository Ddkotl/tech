...
import { BrandList } from "./brands_list";
  ...
  return (
    <div className="relative w-full max-w-[350px] xs1:max-w-[800px]">
      ...
      <Input
        type="text"
        name="search"
        placeholder="🔍 Поиск брэнда по названию..."
        value={searchTerm}
      ...
      <AnimatePresence>
        {isOpen && (
          <>
            ...
            >
              <Title size="lg" text="Результаты поиска:" className="mt-2" />
              <BrandList searchTerm={debouncedSearchTerm} />
            </motion.div>
          </>
        )}
      </AnimatePresence>
