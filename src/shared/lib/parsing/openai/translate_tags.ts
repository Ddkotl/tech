...
Ответь строго строкой с результатами в формате: tag1, tag2, .... Если тэгов нет, то пустую строку "". Не добавляй комментарии,вопросы, пояснения, символы(\`'"/|\<>) или текст вне массива. Вот список тэгов: ${JSON.stringify(tags)}`,
        },
      ],
      temperature: 0,
      model: TEXT_AI_MODEL,
